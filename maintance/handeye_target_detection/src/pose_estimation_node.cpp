...
int main(int argc, char** argv)
{
    ...
    std::string camera_info_topic = parameters_client->get_parameter<std::string>("camera_info_topic", "/camera/color/camera_info");
    std::string publish_image_topic = parameters_client->get_parameter<std::string>("publish_image_topic", "/image/detected");
    ...
    std::string marker_frame_name = parameters_client->get_parameter<std::string>("marker_frame_name", "calib_board");
    std::string camera_frame = parameters_client->get_parameter<std::string>("camera_frame", "none");

    std::stringstream ss;
    ss << "\nParameters:" << std::endl;
    ss << " - pattern: " << pattern << std::endl;
    ss << " - image_topic: " << image_topic << std::endl;
    ss << " - camera_info_topic: " << camera_info_topic << std::endl;
    ss << " - publish_image_topic: " << publish_image_topic << std::endl;
    ss << " - width: " << width << std::endl;
    ss << " - height: " << height << std::endl;
    ss << " - dictionary: " << dictionary << std::endl;
    ss << " - chessboard_square_size: " << chessboard_square_size << std::endl;
    ss << " - circle_grid_seperation: " << circle_grid_seperation << std::endl;
    ss << " - aruco_board_marker_size: " << aruco_board_marker_size << std::endl;
    ss << " - aruco_board_marker_seperation: " << aruco_board_marker_seperation << std::endl;
    ss << " - charuco_board_marker_size: " << charuco_board_marker_size << std::endl;
    ss << " - charuco_board_square_size: " << charuco_board_square_size << std::endl;
    ss << " - marker_frame_name: " << marker_frame_name << std::endl;
    ss << " - camera_frame: " << camera_frame << std::endl;
