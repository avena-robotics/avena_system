...
public:
        ...
        : Node("minimal_publisher"), count_(0)
    {
        ...
        publisher_ = this->create_publisher<ItemCam1Select::Response>("item_cam1",qos_latching);
...
private:
    void timer_callback()
    {
        auto message = ItemCam1Select::Response();
    ...
    rclcpp::Publisher<ItemCam1Select::Response>::SharedPtr publisher_;
    size_t count_;
};
