from custom_interfaces.srv import DataStoreRgbDataGetList
import rclpy
...
class MinimalClientAsync(Node):
    ...
    def __init__(self):
        ...
        self.cli = self.create_client(DataStoreRgbDataGetList, 'rgb_data_get_list')
        while not self.cli.wait_for_service(timeout_sec=1.0):
            self.get_logger().info('service not available, waiting again...')
        self.req = DataStoreRgbDataGetList.Request()
