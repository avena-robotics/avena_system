...
#ifndef GLOBAL_PARAMETER_SERVER__VISIBILITY_CONTROL_H_
#define GLOBAL_PARAMETER_SERVER__VISIBILITY_CONTROL_H_
...
#endif  // GLOBAL_PARAMETER_SERVER__VISIBILITY_CONTROL_H_
