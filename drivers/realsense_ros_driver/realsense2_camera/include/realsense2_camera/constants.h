...
namespace realsense2_camera
{
    ...
    const std::string DEFAULT_ODOM_FRAME_ID            = "_odom_frame";
    const std::string DEFAULT_DEPTH_FRAME_ID           = "depth_camera_link";
    const std::string DEFAULT_INFRA1_FRAME_ID          = "_infra1_frame";
    const std::string DEFAULT_INFRA2_FRAME_ID          = "_infra2_frame";
    const std::string DEFAULT_COLOR_FRAME_ID           = "_color_frame";
    const std::string DEFAULT_FISHEYE_FRAME_ID         = "_fisheye_frame";
    const std::string DEFAULT_IMU_FRAME_ID             = "_imu_frame";

    const std::string DEFAULT_DEPTH_OPTICAL_FRAME_ID   = "_depth_optical_frame";
    const std::string DEFAULT_INFRA1_OPTICAL_FRAME_ID  = "_infra1_optical_frame";
    const std::string DEFAULT_INFRA2_OPTICAL_FRAME_ID  = "_infra2_optical_frame";
    const std::string DEFAULT_COLOR_OPTICAL_FRAME_ID   = "rgb_camera_link";
    const std::string DEFAULT_FISHEYE_OPTICAL_FRAME_ID = "_fisheye_optical_frame";
    const std::string DEFAULT_ACCEL_OPTICAL_FRAME_ID   = "_accel_optical_frame";
    const std::string DEFAULT_GYRO_OPTICAL_FRAME_ID    = "_gyro_optical_frame";
    const std::string DEFAULT_IMU_OPTICAL_FRAME_ID     = "_imu_optical_frame";

    const std::string DEFAULT_ALIGNED_DEPTH_TO_COLOR_FRAME_ID = "_aligned_depth_to_color_frame";
    const std::string DEFAULT_ALIGNED_DEPTH_TO_INFRA1_FRAME_ID = "_aligned_depth_to_infra1_frame";
    const std::string DEFAULT_ALIGNED_DEPTH_TO_INFRA2_FRAME_ID = "_aligned_depth_to_infra2_frame";
    const std::string DEFAULT_ALIGNED_DEPTH_TO_FISHEYE_FRAME_ID = "_aligned_depth_to_fisheye_frame";
