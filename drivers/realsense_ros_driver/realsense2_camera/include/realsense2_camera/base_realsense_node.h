...
namespace realsense2_camera
{
    ...
    private:
        ...
        bool _remove_shadows=true;

        std::string _camera_name;

        std::chrono::time_point<std::chrono::system_clock> _first;
        bool _first_call=true;
        std::vector<int64_t> _time_between_callbacks;
        std::vector<int64_t> _callback_time;
        std::vector<int64_t> _allign_time;
