...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera_4', 'description': 'camera unique name'},
                        ...
                        #    {'name': 'temporal.holes_fill', 'default': '1', 'description': ' valid in 8/8 '},                                
                           ...
                           {'name': 'base_frame_id',                'default': 'camera_4/camera_base', 'description': ''},
...
def generate_launch_description():
    return LaunchDescription(declare_configurable_parameters(configurable_parameters) + [
        ...
        launch_ros.actions.Node(
            ...
            emulate_tty=True,
            remappings=[
                ('/camera_4/aligned_depth_to_rgb/image_raw', '/camera_4/depth_to_rgb/image_raw'),  # depths
                ('/camera_4/aligned_depth_to_rgb/camera_info', '/camera_4/depth_to_rgb/camera_info'),  # camera info
                ('/camera_4/depth/color/points', '/camera_4/points2'),  # Points
            ]
        ),
        launch_ros.actions.Node(
            condition=IfCondition(PythonExpression(["'", LaunchConfiguration('config_file'), "' != ''"])),
