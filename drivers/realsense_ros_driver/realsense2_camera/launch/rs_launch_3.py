...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera_3', 'description': 'camera unique name'},
                           {'name': 'serial_no',                    'default': '_114122250518', 'description': 'choose device by serial number'},
                           {'name': 'usb_port_id',                  'default': '', 'description': 'choose device by usb port id'},
                           {'name': 'device_type',                  'default': '', 'description': 'choose device by type'},
                           {'name': 'config_file',                  'default': '', 'description': 'yaml config file'},
                        #    {'name': 'config_file',                  'default': arguments_file_path, 'description': 'yaml config file'},
                           ...
                           {'name': 'rgb_camera.exposure',          'default': '166', 'description': 'dont change it to 333 !!!'},
                        ...
                        #    {'name': 'spatial.holes_fill', 'default': '4', 'description': 'Size of the radius which should be used for filling holes'},
                           ...
                           {'name': 'base_frame_id',                'default': 'camera_3/camera_base', 'description': ''},
...
def generate_launch_description():
    return LaunchDescription(declare_configurable_parameters(configurable_parameters) + [
        ...
        launch_ros.actions.Node(
            ...
            emulate_tty=True,
            remappings=[
                ('/camera_3/aligned_depth_to_rgb/image_raw', '/camera_3/depth_to_rgb/image_raw'),  # depths
                ('/camera_3/aligned_depth_to_rgb/camera_info', '/camera_3/depth_to_rgb/camera_info'),  # camera info
                ('/camera_3/depth/color/points', '/camera_3/points2'),  # Points
            ]
        ),
        launch_ros.actions.Node(
            condition=IfCondition(PythonExpression(["'", LaunchConfiguration('config_file'), "' != ''"])),
