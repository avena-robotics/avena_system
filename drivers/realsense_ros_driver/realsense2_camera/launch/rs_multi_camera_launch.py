...
def generate_launch_description():
    params1 = duplicate_params(rs_launch_1.configurable_parameters, '1')
    params2 = duplicate_params(rs_launch_2.configurable_parameters, '2')
    params3 = duplicate_params(rs_launch_3.configurable_parameters, '3')
    params4 = duplicate_params(rs_launch_4.configurable_parameters, '4')

    return LaunchDescription(
        rs_launch_1.declare_configurable_parameters(params1) + 
        rs_launch_2.declare_configurable_parameters(params2) + 
        rs_launch_3.declare_configurable_parameters(params3) + 
        rs_launch_4.declare_configurable_parameters(params4) + 
        [
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([ThisLaunchFileDir(), '/rs_launch_1.py']),
            launch_arguments=set_configurable_parameters(params1).items(),
        ),
           IncludeLaunchDescription(
            PythonLaunchDescriptionSource([ThisLaunchFileDir(), '/rs_launch_2.py']),
            launch_arguments=set_configurable_parameters(params2).items(),
        ),
           IncludeLaunchDescription(
            PythonLaunchDescriptionSource([ThisLaunchFileDir(), '/rs_launch_3.py']),
            launch_arguments=set_configurable_parameters(params3).items(),
        ),
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([ThisLaunchFileDir(), '/rs_launch_4.py']),
