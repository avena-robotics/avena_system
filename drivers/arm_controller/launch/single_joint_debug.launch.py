...
def launch_setup(context, *args, **kwargs):
    ...
    amp_arg = DeclareLaunchArgument('sin_amp', default_value = '2.8')
    time_arg = DeclareLaunchArgument('trajectory_period', default_value = '24.')

    

    return [amp_arg,time_arg,
        Node(
        ...
        Node(
            ...
            output='both',
            parameters=[params, {'config_path':config,'sin_amp':LaunchConfiguration('sin_amp'),'trajectory_period':LaunchConfiguration('trajectory_period')}]
        )
    ]
