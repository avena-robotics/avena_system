...
namespace octomap_generator
{
  ...
  private:
    ...
    void _getData(custom_interfaces::msg::Ptclds::SharedPtr &cameras_data);

    int _validateInputs(custom_interfaces::msg::Ptclds::SharedPtr cameras_data);
    ...
    int _sendDataToDB(ptcld_transformer::TransformedPointClouds::SharedPtr &octomap_msg);
