...
namespace get_cameras_data
{
  ...
  public:
    ...
    // void initNode() override; //push start button
  ...
  private:
    ...
    void _synchronizedTopicsCallback(const sensor_msgs::msg::Image::ConstSharedPtr &cam1_rgb, const sensor_msgs::msg::Image::ConstSharedPtr &cam2_rgb);
    ...
    // message_filters::Subscriber<sensor_msgs::msg::PointCloud2> _point_cloud1_sub;
    ...
    // message_filters::Subscriber<sensor_msgs::msg::PointCloud2> _point_cloud2_sub;
